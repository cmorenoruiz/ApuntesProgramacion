...
public class CuentaBancaria {
    ...
    // Comprobamos IBAN y Titular válidos o no
    // Propuesta de Crisitna de  métodos estáticos
    //para poder utilizarlos sin crear cuenta bancaria

    public static boolean esValidoIBAN(String iban){
        return iban.matches("[A-Z]{2}\\d{22}");
    }

    public static boolean esValidoTitular(String titular){
        return titular.matches("[a-zA-Z]+[a-zA-Z\\s]*");
    }
